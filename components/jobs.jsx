...
// ─── Job details (extend this as needed) ────────────────────────────────────
const jobDetails = {
  1: {
    overview:
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <div className="bg-[#085689] rounded-t-3xl p-6 text-white relative">
          <button
            onClick={onClose}
          ...
          <h2 className="text-xl font-bold leading-tight pr-10 mb-1 text-white">{job.title}</h2>
        ...
        <div className="px-6 pb-6 text-center">
          <button
            ...
            className="bg-[#085689] hover:bg-[#0a6a9e] text-white py-3.5 px-4 rounded-2xl font-semibold text-base transition-all active:scale-[0.98]"
          >
            Apply for this role
          </button>
        </div>
...
// ─── Main section (unchanged except selectedJob state + modal) ───────────────
export function JobsSection() {
  ...
  const [selectedJob, setSelectedJob] = React.useState(null); // ← NEW
